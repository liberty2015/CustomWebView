...
public class CustomWebView extends WebView implements NestedScrollingChild {
    ...
    public CustomWebView withURL(String url){
        this.Url=url;
        return this;
    }

    public CustomWebView startLoad(){
        if (Url!=null){
            switch (loadType){
                case POST:
                    if (params!=null){
    ...
    public CustomWebView withScreenChangeListener(ScreenChangeListener listener){
        this.listener=listener;
        return this;
    }
    //支持JavaScript
    public CustomWebView withJavaScriptEnabled(boolean isEnabled){
        isSettingNull();
        settings.setJavaScriptEnabled(isEnabled);
        return this;
    }

    public CustomWebView withLoadType(String type){
        this.loadType=type;
        return this;
    }

    public CustomWebView withJavaScriptCanOpenWindowsAutomatically(boolean isEnabled){
        isSettingNull();
        settings.setJavaScriptCanOpenWindowsAutomatically(isEnabled);
        return this;
    }
    //使页面自适应屏幕
    public CustomWebView withUseWideViewPort(boolean isEnabled){
        isSettingNull();
        settings.setUseWideViewPort(isEnabled);
        return this;
    }
    //缩放至屏幕的大小
    public CustomWebView withLoadWithOverviewMode(boolean isEnabled){
        isSettingNull();
        settings.setLoadWithOverviewMode(isEnabled);
        return this;
    }
    //支持自动加载图片
    public CustomWebView withLoadsImagesAutomatically(boolean isEnabled){
        isSettingNull();
        settings.setLoadsImagesAutomatically(isEnabled);
        return this;
    }

    public CustomWebView withUserAgent(String userAgent){
        isSettingNull();
        settings.setUserAgentString(settings.getUserAgentString()+userAgent);
        return this;
    }

    public CustomWebView withDomStorageEnabled(boolean isEnabled){
        isSettingNull();
        settings.setDomStorageEnabled(isEnabled);
        return this;
    }

    public CustomWebView withSaveFormData(boolean isEnabled){
        isSettingNull();
        settings.setSaveFormData(isEnabled);
        return this;
    }

    public CustomWebView withLoadUrlType(){
        isSettingNull();
    ...
    public CustomWebView withProgressView(ProgressBar progressView){
        this.progressBar=progressView;
        return this;
    }

    public CustomWebView withWebviewChromeClient(){
        this.chromeClient=new CustomWebViewChromeClient();
        this.setWebChromeClient(this.chromeClient);
        return this;
    }

    public CustomWebView withWebviewChromeClient(WebChromeClient client){
        this.setWebChromeClient(client);
        return this;
    }

    public CustomWebView withWebViewClient(){
        this.setWebViewClient(new CustomWebViewClient());
        return this;
    }

    public CustomWebView withWebViewClient(WebViewClient client){
        this.setWebViewClient(client);
        return this;
    }

    public CustomWebView withVideoView(FrameLayout videoView){
        this.videoView=videoView;
        return this;
    }

    public CustomWebView withVideoProgressLayoutId(int id){
        this.progressId=id;
        return this;
    }
